...
## Create a function that takes a string and puts all the splitting functions together
## that will convert a raw string of markdown-flavoured text into a list of TextNode objects.
